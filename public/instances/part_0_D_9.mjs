...
rs.quadSplitParams = {Case:3,fr0:.4,fr1:.4,fr2:0.4,fr3:0.4,fr4:0.7,fr5:0.3,p4stop:1};
...
rs.afterInitialize = function () {
 debugger;
  ...
  addT('Case',3,Point.mk(0*ff,-(hwd+3*ff)));
  ...
  addT('Q',0,Point.mk(-8*ff,hwd-4.5*ff));
  addT('Q',3,Point.mk(8*ff,hwd-4.5*ff));
  //addT('fr',3,Point.mk(-5*ff,-0.0*ff));
  //addT('fr',5,Point.mk(0*ff,1*ff));
  addT('Q',2,Point.mk(8*ff,-5*ff));
  addT('Q',4,Point.mk(0*ff,0*ff));
