...
rs.setTopParams = function () {
  let wd = 1000;
  let ht = 0.7*wd;
  let people = [{name:'Boole',birth:1815,death:1864,whichLine:-5,skip:0},{name:'Cantor',birth:1845,death:1918,whichLine:-4,skip:0},
                {name:'Frege',birth:1848,death:1925,whichLine:-3,skip:0},{name:'Gödel',birth:1906,death:1978,whichLine:0,skip:0},
                {name:'Russell',birth:1872,death:1970,whichLine:-1,skip:0},{name:'Turing',birth:1912,death:1954,whichLine:1,skip:0},
              {name:'Zermelo',birth:1871,death:1953,whichLine:-2,skip:0}, {name:'Kripke',birth:1940,death:2022,whichLine:2,skip:0},
