...
let topParams = {width:ht,height:ht,maxDrops:60000,dropTries:50,webTries:1000,segLength:2,frameColor:'rgb(2,2,2)',framePadding:0.1*ht,minSeparation:0,minConnectorLength:300,maxConnectorLength:600,shortenBy:20}
